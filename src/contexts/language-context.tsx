...
const translations = {
  fr: {
    ...
    "quote.siteType.simple": "Site vitrine simple (1 à 5 pages)",
    "quote.siteType.simpleDesc": "Idéal pour présenter votre activité avec les pages essentielles",
    "quote.siteType.advanced": "Site vitrine avancé (5 à 10 pages)",
    "quote.siteType.advancedDesc": "Pour une présence web complète avec plus de contenu",
  ...
  nl: {
    ...
    "quote.siteType.advanced": "Geavanceerde showcase site (5 tot 10 pagina's)",
  ...
  en: {
    ...
    "quote.siteType.advanced": "Advanced showcase site (5 to 10 pages)",
