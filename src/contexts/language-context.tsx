...
const translations = {
  fr: {
    ...
    // Announcement Banner
    "announcement.offer": "🎁 -30% jusqu'au 31/12/25 + 1 mois de maintenance offert !",
  ...
  nl: {
    ...
    // Announcement Banner
    "announcement.offer": "🎁 -30% tot 31/12/25 + 1 maand onderhoud gratis!",
  ...
  en: {
    ...
    // Announcement Banner
    "announcement.offer": "🎁 -30% until 12/31/25 + 1 month free maintenance!",
